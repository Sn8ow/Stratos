...
client.on("ready", () => {
        ...
        console.log("            dP                       dP ")                     
        console.log("            88                       88 ")                     
        console.log(" .d8888b. d8888P 88d888b. .d8888b. d8888P .d8888b. .d8888b. ") 
        console.log(" Y8ooooo.   88   88'  `88 88'  `88   88   88'  `88 Y8ooooo. ") 
        console.log("       88   88   88       88.  .88   88   88.  .88       88 ")
        console.log(" `88888P'   dP   dP       `88888P8   dP   `88888P' `88888P' ")
        console.log('\x1b[37m',"-------------------------------------------------------------")                                                                                 
	console.log(" ")
	console.log('\x1b[31m',"[Bot Info] Prefix: !")
	console.log(" [Bot Info] Version: V1.0 Release")
	console.log(" [Bot Info] Use !help for a list of commands.")
	console.log(" [Credit] This bot was made by: Sn8ow.")
	console.log(" [Discord] https://discord.gg/MUghFw7e6p")
	console.log(" ")
	console.log('\x1b[37m',"--System Log:--")
	console.log('\x1b[31m',">Stratos is now online.")
})
...
client.on("message", async message => {
      ...
      const command = args.shift().toLowerCase();
		  ...
		  console.log(" ")
		  console.log('\x1b[37m',"                   --Stratos Command List:--")
